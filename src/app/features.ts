export type FeatureKey = "live" | "linked" | "tracked" | "activity-history" | "death-reports" | "damage" | "dot-lab" | "splits" | "compounds" | "merchant" | "wts" | "characters" | "spells" | "gems" | "imports" | "items" | "database" | "system" | "logs" | "help" | "changes";
...
export const FEATURES:FeatureDefinition[] = [
 ...
 {key:"dot-lab",label:"DoT Training Lab",shortLabel:"DoT Lab",icon:"T",phase:2,group:"Combat",description:"Paste combat logs into an isolated simulation and inspect every DoT match, attribution, tick, and chart decision."},
