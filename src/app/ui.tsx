...
type Props<T> = {rows:T[]; columns:Column<T>[]; rowKey:(row:T)=>string|number; actions?:(row:T)=>ReactNode; selected?:Set<string|number>; onSelected?:(next:Set<string|number>)=>void; empty?:string; dimInsteadOfHide?:boolean};
