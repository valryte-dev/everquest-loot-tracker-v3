...
export interface ActiveDot { id:number; spellName:string; targetName:string; casterName:string; attributionMethod:"item_glow"|"next_attack"|"unknown"; landedAt:string; expiresAt:string; damagePerTick:number; tickIntervalSeconds:number; totalTicks:number; ticksApplied:number; inferenceEnabled:boolean; status:string }
...
export interface DotTrainingApplication { id:number; encounterId:number; spellName:string; targetName:string; casterName:string; attributionMethod:"item_glow"|"next_attack"|"unknown"; landedAt:string; expiresAt:string; damagePerTick:number; tickIntervalSeconds:number; totalTicks:number; ticksApplied:number; inferenceEnabled:boolean; status:string; sourceOffset:number }
