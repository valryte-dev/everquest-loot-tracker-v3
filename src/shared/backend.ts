...
const previewSnapshot:AppSnapshot={settings:{theme:"midnight",merchant_mode_enabled:"false"},members:[],loot:[],splits:[],tracked:[],linkedLoot:[],history:[],items:[],inventory:[],questCatalog:[],researchCatalog:[],spells:[],characterProfiles:[],wts:[],aliases:[],mobs:[],logs:[],imports:[],merchant:[],deathReports:[],damageEncounters:[],damageEncounterCount:0,damageDistinctMobCount:0,damageAttackTypes:[],compound:{projects:[],templates:[],activeId:null}};
const desktop=()=>"__TAURI_INTERNALS__" in window;
export const bootstrapStatus=()=>desktop()?invoke<BootstrapStatus>("bootstrap_status"):Promise.resolve(previewStatus);
export const getModelPackStatus=():Promise<ModelPackStatus>=>desktop()?invoke<ModelPackStatus>("model_pack_status"):Promise.resolve({installed:false,valid:false,latestVersion:"7",updateAvailable:false,modelCount:0,fileCount:0,bytes:0});
...
export const getWardrobeCatalogItem=(itemId:number|undefined,itemName:string)=>desktop()?invoke<WardrobeCatalogItem|null>("wardrobe_catalog_item",{itemId,itemName}):Promise.resolve(null);
